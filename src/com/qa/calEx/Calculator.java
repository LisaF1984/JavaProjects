...
//and is quite common in most languages. this is because we were using ints rather than doubles. 
//Modify the division method so that it takes Double parameters and then return a Double, if not already.
	...
	// if the
	// first parameter is smaller than the second, otherwise it prints out a
...
// % - modulus
	...
	public static int oddEven(int a) {
		int c = a%2; //single = sign is an assignment operator ( whatever the result of this is i'm putting this into c)
